...
const QUICK_SUGGESTIONS = [
  ...
  "📞 Falar com Engenheiro no WhatsApp (15) 98100-9064",
];
...
const getClientFallbackResponse = (message: string): string => {
  ...
  if (lowerMsg.includes("rede") || lowerMsg.includes("wifi") || lowerMsg.includes("wi-fi") || lowerMsg.includes("ip") || lowerMsg.includes("dns") || lowerMsg.includes("internet") || lowerMsg.includes("vpn")) {
    ...
    return `💻 **Desenvolvimento de Software & Banco de Dados**\n\nDesenvolvemos sistemas corporativos sob medida com arquitetura moderna e segura:\n- **Linguagens:** C#/.NET, Java, Python, C/C++, Flutter, Delphi e TypeScript\n- **Bancos de Dados:** PostgreSQL, SQL Server, Firebird, MySQL e MongoDB\n- **Arquitetura:** APIs REST/GraphQL, microsserviços, sistemas fiscais e automação comercial\n\nPrecisa desenvolver um software ou sistema sob medida?`;
    ...
    return `Desenvolvemos **Assistentes Virtuais & Chatbots com Inteligência Artificial** sob medida! 💬✨\n\nFuncionam 24/7 em sites, WhatsApp ou sistemas internos, realizando atendimentos automáticos, qualificação de oportunidades, suporte de TI e respostas técnicas.\n\nGostaria de ver uma demonstração ou integrar um assistente inteligente no seu negócio?`;
  } else {
    return `Olá! Sou o **DibiBot AI**, assistente virtual e consultor de atendimento em TI e Engenharia da **dibiTECH TI & Automação**. 👋\n\nPosso ajudar você com:\n• **Atendimento e Orçamentos de Serviços dibiTECH**\n• **Diagnósticos de TI, Redes & Segurança Cibernética**\n• **Projetos de Automação Industrial (CLP, SCADA, IHMs)**\n• **Sistemas & ERPs sob medida**\n• **Infraestrutura de Nuvem & Servidores**\n\nComo posso ajudar você hoje? Se desejar, também pode nos chamar no **WhatsApp (15) 98100-9064**!`;
  }
};
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome-1",
      sender: "bot",
      text: "Olá! Sou o **DibiBot AI**, o assistente virtual de atendimento da **dibiTECH TI & Automação**. 👋\n\nComo posso ajudar no seu atendimento hoje? Posso tirar dúvidas técnicas de TI, redes, segurança cibernética, automação industrial ou fornecer orçamentos para novos projetos!",
